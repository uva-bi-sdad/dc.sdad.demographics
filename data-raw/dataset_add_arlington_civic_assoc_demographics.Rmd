...
Ex: dc_common.va013_ca_sdad_2013_2019_civ_assoc_demographics: civic_assoc_dmg_est_arlington.R


```{r data}

# Ex database_table_name: "va_hd_vdoe_2019_2021_3rd_grade_mean_median_read_score"
table_names = c("va013_ca_sdad_2013_2019_civ_assoc_demographics") 
    
con <- get_db_conn()

dat_file_name <- table_names[1]
db_schema_name <- "dc_common"  # Ex database schema_name: dc_education_training
...
all_geos_file_name <- "va013_ca_sdad_2013_2019_civ_assoc_demographics"  #Ex: "va_vdoe_2019_2021_3rd_grade_mean_median_read_score"
